...
<script>
  ...
  export default {
    name: 'Main',
    components: {
      'query-item-supplier': QueryItemSupplier,
      'table-item-supplier': TableItemSupplier,
      'add-edit-item-supplier': AddEditItemSupplier,
      'detail-item-supplier': DetailItemSupplier,
