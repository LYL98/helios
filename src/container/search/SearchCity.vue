  ...
  <div>
    ...
    <div style="display: flex; align-items: center;">
      <my-select-zone
        ...
        clearable
      ></my-select-zone>
      <el-input v-model="cityTitle" style="width: 200px; margin: 0 10px;" placeholder="输入县域名称搜索" clearable @keyup.enter.native="selectByCondition" />
    ...
    <div style="display: flex; align-items: center; margin-top: 20px;">
      ...
      <el-table :data="editList" height="400px" style="border: 1px solid #DCDFE6; border-radius: 2px;" :row-class-name="highlightRowClassName">
        <el-table-column label="已添加的县域列表" prop="title"></el-table-column>
