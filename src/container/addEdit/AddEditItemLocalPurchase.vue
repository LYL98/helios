      ...
      <el-form class="custom-form" size="mini" label-position="right" :disabled="pageType === 'detail'" label-width="140px" :model="detail" :rules="rules" ref="ruleForm">
        ...
        <el-row>
          <el-form-item label="商品" prop="item_id">
            <select-item v-model="detail.item_id" placeholder="商品编号/名称" size="medium" supType="local_pur" @change="selectGItem" :disabled="pageType !== 'add' ? true : false" filterable clearable></select-item>
          </el-form-item>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="供应商" prop="supplier_id">
              <select-supplier supplierType="local_pur" size="medium" :pItemId="detail.p_item_id" v-model="detail.supplier_id" :disabled="pageType !== 'add' ? true : false" filterable/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
