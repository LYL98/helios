  ...
  <div>
    <add-edit-layout :title="pageTitles[pageType]" :isShow="isShow" direction="ttb" :before-close="handleCancel" type="drawer">
      ...
      <div style="margin-left: 110px; margin-top: 80px;">
        ...
        <template v-else>
          <el-button size="medium" type="text" style="margin-right: 20px;" @click.native="pageType = 'edit'" v-if="(auth.isAdmin || auth.SupplierGPurchaseEdit) && pageType === 'detail'">修改</el-button>
