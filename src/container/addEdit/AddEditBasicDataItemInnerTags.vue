<template>
  <div class="user-reset-password">
    <el-dialog :close-on-click-modal="false" :title="`${detail.id?'编辑':'新增'}商品内标签`" :visible="isShow" width="720px" :before-close="handleCancel">
  ...
  data(){
    return{
      ...
      rules: {
        ...
        rank: [
          { pattern: Verification.testStrs.isNumber, message: '排序必须为正整数数字', trigger: 'change' },
        ]
      }
    }
  },
