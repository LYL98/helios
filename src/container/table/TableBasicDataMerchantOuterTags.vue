<template>
  <div>
    <div class="operate" v-if="auth.isAdmin || auth.BasicDataMerchantOuterTagsListAdd">
      <el-button @click="handleShowAddEdit('AddEditBasicDataMerchantOuterTags')" size="mini" type="primary" v-if="auth.isAdmin || auth.BasicDataMerchantOuterTagsListAdd">新增</el-button>
    </div>
    <!-- 表格start -->
